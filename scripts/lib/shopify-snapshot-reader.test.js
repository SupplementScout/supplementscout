...
test("reads all Shopify pages and seals a deterministic manifest", async () => {
  ...
  assert.deepEqual(projectShopifyVariants({ products: [{ id: 1, handle: "p", variants: [{ id: 2, price: "9.99", available: true }] }] }, { shippingCost: "3.99" })[0], { external_product_id: "1", external_variant_id: "2", product_handle: "p", price: "9.99", shipping_cost: "3.99", in_stock: true, source_updated_at: null });
});
