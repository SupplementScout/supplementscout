...
begin
  if current_user<>'postgres' or v_target->>'target_environment'<>'PRODUCTION'
     ...
     or not exists(select 1 from supabase_migrations.schema_migrations where version='20260825212000' and name='create_jons_exact_pack_ordinary_servings_c_10') then
