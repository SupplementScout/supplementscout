...
function parseArgs(argv) {
  ...
  if (
    !["six-pack-production-family-v3", "six-pack-production-family-v6-bootstrap", "six-pack-production-expansion-v6", "six-pack-production-expansion-v7", "six-pack-production-expansion-v8", "six-pack-production-expansion-v9", "six-pack-production-expansion-v10", "six-pack-production-expansion-v11"].includes(options.kind) ||
...
function build(csvBytes, report, approvalValue = approval, rolloutOptions = {}) {
  ...
  if (
    ...
    !["six-pack-reviewed-family-batch-v1", "six-pack-reviewed-family-map-batch-v4", "six-pack-reviewed-family-map-batch-v5", "six-pack-reviewed-large-family-batch-v7", "six-pack-reviewed-large-family-batch-v8", "six-pack-reviewed-large-family-batch-v9", "six-pack-reviewed-large-family-batch-v10", "six-pack-reviewed-large-family-batch-v11"].includes(approvalValue.kind) ||
