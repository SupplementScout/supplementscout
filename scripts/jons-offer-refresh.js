...
async function buildRun(target,state,diagnostic=null){
  ...
  if(classification.state!=="DRY_RUN_READY"||classification.rows.length!==506)throw new RefreshError(classification.reason||"CLASSIFIER_BLOCKED","full Jon's classifier blocked","CLASSIFIER",{...(classification.detail||{}),guard_evidence:classification.guard_evidence||null});
