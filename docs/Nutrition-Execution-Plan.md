...
One next step is to prepare the next closed NUT-03 family package only when its
official evidence is available, without reopening recorded blockers or
reprocessing these 68 variants.
