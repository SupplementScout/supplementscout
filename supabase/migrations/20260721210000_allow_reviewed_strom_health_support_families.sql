...
do $postflight$
begin
  if not public.atomic_import_reviewed_parent_variant_allowed('Strom Sports FocusMax 36 Servings','Strom','Health Supplements','powder','36','servings')
     or not public.atomic_import_reviewed_parent_variant_allowed('Strom Sports GlutathioneMAX 200g','Strom','Health Supplements','powder','200','g')
     or not public.atomic_import_reviewed_parent_variant_allowed('Strom Sports SystolMAX 495g','Strom','Health Supplements','powder','495','g')
     or not public.atomic_import_reviewed_parent_variant_allowed('Strom Sports DigestMax 480g','Strom','Health Supplements','powder','480','g')
     or not public.atomic_import_reviewed_parent_variant_allowed('Strom MSM (Methylsulfonylmethane) 83 Servings','Strom','Health Supplements','powder','83','servings')
     or public.atomic_import_reviewed_parent_variant_allowed('Strom Sports UnknownMAX 480g','Strom','Health Supplements','powder','480','g') then
    raise exception 'exact reviewed Strom health-support policy verification failed';
  end if;
end
$postflight$;
