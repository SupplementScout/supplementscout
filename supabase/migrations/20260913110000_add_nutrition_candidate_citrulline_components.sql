...
alter table public.nutrition_candidates
  add constraint nutrition_candidates_proposed_field_check check ((
    proposed_field in (
      ...
      'citrulline_per_serving_mg', 'citrulline_component_per_serving_mg',
...
comment on column public.nutrition_candidates.ingredient_form is
  'Declared citrulline or creatine form. Citrulline components retain separate declared masses; compound mass is not converted to pure active-ingredient mass.';
