...
alter table public.nutrition_candidates
  add constraint nutrition_candidates_proposed_field_check check ((
    proposed_field in (
      ...
      'citrulline_per_serving_mg', 'citrulline_component_per_serving_mg', 'creatine_component_per_serving_mg',
  ...
  add constraint nutrition_candidates_fact_shape_check check ((
    ...
    (
      proposed_field in (
        ...
        'citrulline_component_per_serving_mg', 'creatine_component_per_serving_mg',
        'beta_alanine_per_serving_mg',
        'creatine_declared_form_per_serving_mg'
      )
      ...
      and (
        (
          ...
          and (
            (
              ...
              and ingredient_form in ('l_citrulline', 'citrulline_malate', 'citrulline_nitrate')
            )
            or (
        ...
        or (
          ...
          and information_state = 'present_with_amount'
          and ingredient_form in ('l_citrulline', 'citrulline_malate', 'citrulline_nitrate')
          and (
            ingredient_ratio is null
            or (
...
comment on column public.nutrition_candidates.ingredient_form is
  'Declared citrulline or creatine form. Citrulline and creatine components retain separate declared masses; compound mass is not converted to pure active-ingredient mass.';
