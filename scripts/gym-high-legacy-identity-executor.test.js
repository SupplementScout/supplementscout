...
const activeWorkflow = path.resolve(__dirname, "../.github/workflows/gym-high-legacy-identity-upgrade.yml");
const archivedWorkflow = path.resolve(__dirname, "../docs/archive/completed-workflows/gym-high-legacy-identity-upgrade.yml");
...
test("completed workflow is archived and keeps its exact role-separated evidence", () => {
