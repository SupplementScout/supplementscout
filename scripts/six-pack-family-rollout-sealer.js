...
function parseArgs(argv) {
  ...
  if (
    !["six-pack-production-family-v3", "six-pack-production-family-v6-bootstrap", "six-pack-production-expansion-v6", "six-pack-production-expansion-v7", "six-pack-production-expansion-v8", "six-pack-production-expansion-v9", "six-pack-production-expansion-v10", "six-pack-production-expansion-v11", "six-pack-production-expansion-v12", "six-pack-production-expansion-v13", "six-pack-production-expansion-v14"].includes(options.kind) ||
...
function build(csvBytes, report, approvalValue = approval, rolloutOptions = {}) {
  ...
  if (
    ...
    !["six-pack-reviewed-family-batch-v1", "six-pack-reviewed-family-map-batch-v4", "six-pack-reviewed-family-map-batch-v5", "six-pack-reviewed-large-family-batch-v7", "six-pack-reviewed-large-family-batch-v8", "six-pack-reviewed-large-family-batch-v9", "six-pack-reviewed-large-family-batch-v10", "six-pack-reviewed-large-family-batch-v11", "six-pack-reviewed-large-family-batch-v12", "six-pack-reviewed-large-family-batch-v13", "six-pack-reviewed-large-family-batch-v14"].includes(approvalValue.kind) ||
  ...
  const rollout = {
    ...
    ...(isLargeFamilyBatch
      ? {
          approved_scope_row_count:
            approvalValue.source_candidate_count || approvedRows.length,
          covered_duplicate_aliases: coveredDuplicateAliases,
          ...(approvalValue.source_aliases
            ? { reviewed_source_aliases: approvalValue.source_aliases }
            : {}),
