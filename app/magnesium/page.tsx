    ...
    <main className="min-h-screen bg-zinc-50 text-zinc-950">
      <header className="border-b border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 sm:py-5">
          ...
          <Link href="/search?q=magnesium" className="text-sm font-semibold text-zinc-700 hover:text-zinc-950">
            Search magnesium
          </Link>
        </div>
      </header>
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-base leading-7 text-zinc-700 sm:text-lg sm:leading-8">
            ...
            retailers. Compare product prices, delivery costs and total delivered
            prices in one place.
          </p>
          <p className="mt-4 text-sm leading-6 text-zinc-600">
            Magnesium supplements are commonly chosen by people looking to
            support their general nutrition, especially when comparing different
            forms, strengths and formulas. Always check the product label to see
            what each supplement contains.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-8 sm:px-6 sm:pb-12">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold sm:text-3xl">
              Magnesium supplement deals
            </h2>
          </div>
          <Link
            href="/search?q=magnesium"
        ...
        {error && (
          <div className="mt-6 rounded-lg border border-red-200 bg-red-50 p-5 text-red-700">
            ...
            <p className="mt-1 text-sm">
              Please try the magnesium search page instead.
            </p>
          </div>
        )}
        ...
        {!error && results.length === 0 && (
          <div className="mt-6 rounded-lg border border-zinc-200 bg-white p-6 text-center sm:p-8">
            <h2 className="text-2xl font-bold">No magnesium deals found</h2>
            <p className="mx-auto mt-3 max-w-2xl text-zinc-600">
              No active magnesium products with in-stock delivered offers are
        ...
        <div className="mx-auto grid max-w-7xl gap-6 px-4 py-8 sm:px-6 sm:py-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 leading-7 text-zinc-700">
              SupplementScout compares in-stock offers from UK retailers. Product
              price is the shelf price of the supplement. Delivery cost is the
              retailer delivery charge where known. Total delivered price combines
              the product price and delivery cost so you can compare offers more
              clearly.
            </p>
            <p className="mt-3 text-sm leading-6 text-zinc-600">
              Retailer availability can change, so check the retailer page before
              buying. Some retailer links may be affiliate links. This does not
              change the price you pay.{" "}
              <Link href="/affiliate-disclosure" className="font-semibold text-zinc-950 underline">
