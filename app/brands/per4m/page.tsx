...
export function buildPer4mStructuredData(rows: Per4mBrandRow[]) {
  ...
  return {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "ItemList",
        "@id": itemListId,
        name: "Per4m products with recently checked UK retailer offers",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Per4m", item: pageUrl },
        ],
      },
    ],
  };
      ...
      <div className="grid grid-cols-[96px_minmax(0,1fr)] gap-4 lg:grid-cols-[128px_minmax(0,1fr)_20rem] lg:items-center lg:gap-5">
        ...
        <div className="min-w-0">
          <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">
            {position}. {per4mDisplayCategory(row)}
          </p>
...
export function Per4mPageContent({ result }: { result: Per4mBrandResult }) {
  const structuredDataValid = isPer4mStructuredDataValid(result.rows);
  const jsonLd = structuredDataValid
    ? buildPer4mStructuredData(result.rows)
    : null;
  const latestCheck = formatCheckedAt(result.summary.latestOfferCheckedAt);

  return (
    <main className="min-h-screen bg-zinc-50 text-zinc-950">
      <CategoryViewAnalytics category="Per4m" sourcePage="per4m_brand" />
      {jsonLd && (
        <script
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mt-6 max-w-4xl">
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight sm:text-5xl">
            Per4m Products &amp; Prices UK
          </h1>
          <p className="mt-5 text-base leading-7 text-zinc-700 sm:text-lg sm:leading-8">
            Compare recently checked Per4m offers from UK supplement retailers.
        ...
        <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 sm:pb-14">
          <div className="rounded-2xl border border-zinc-200 bg-white p-5 sm:p-6">
            ...
            <p className="mt-3 max-w-4xl leading-7 text-zinc-700">
              SupplementScout currently has fresh Per4m offers across {result.categories.length}{" "}
      ...
      <section className="mx-auto max-w-7xl px-4 pb-10 sm:px-6 sm:pb-14">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-bold sm:text-3xl">
              Per4m prices and retailer coverage
            </h2>
          </div>
        ...
        {result.error && (
          <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-6">
            ...
            <Link href="/search?brand=Per4m" className="mt-4 inline-flex font-semibold underline">
              Search Per4m products
            </Link>
          </div>
        )}
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-3 leading-7 text-zinc-700">
              ...
              Per4m are included. Offers must be mapped, in stock, positive-priced
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14">
        <h2 className="text-2xl font-bold">Per4m price questions</h2>
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <div>
            <h3 className="font-bold">Are all Per4m products shown?</h3>
            <p className="mt-2 leading-7 text-zinc-700">
        ...
        <aside className="mt-10 rounded-xl border border-zinc-200 bg-white p-6">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            ...
            <Link href="/search?brand=Per4m" className="font-semibold underline">Search this brand</Link>
