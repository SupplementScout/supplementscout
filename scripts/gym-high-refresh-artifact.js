...
function buildRefreshArtifact(options, dependencies = {}) {
  ...
  const report = {
    ...
    result: (builderReport.review_row_count || 0) > 0 ? "PASS_WITH_REVIEW" : "PASS",
    database_writes: 0,
    ...
    executable_row_count: approvedRows.length,
    review_row_count: builderReport.review_row_count || 0,
    review_rows: builderReport.review_rows || [],
